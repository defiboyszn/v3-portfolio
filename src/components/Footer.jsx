                ...
                <div>
                    <div className="flex flex-col md:flex-row justify-between items-center gap-10 mt-10 mb-10">
                        <ul className="flex flex-row justify-between items-center gap-10">
                            <li><a className="font-clash-display font-[400] text-[16px]" href="/">Home</a></li>
                            <li><a className="font-clash-display font-[400] text-[16px]" href="/#about">About</a></li>
                            <li><a className="font-clash-display font-[400] text-[16px]" target="_blank" href="https://blog.heistobi.xyz">Blog</a></li>
                        </ul>


                        <p className="font-clash-display font-[400] text-[16px]">© 2023 Tobi</p>


                        <ul className="flex flex-row justify-between items-center gap-10">
                            <li><a className="font-clash-display font-[400] text-[16px]" href="https://twitter.com/realtobi_eth">Twitter</a></li>
                            <li><a className="font-clash-display font-[400] text-[16px]" href="https://linkedin.com/in/tobithealpha">Linkedin</a></li>
                            <li><a className="font-clash-display font-[400] text-[16px]" href="https://github.com/tobithedev">Github</a></li>
