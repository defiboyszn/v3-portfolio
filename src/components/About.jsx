...
export const About = () => {
  ...
  return (
    <>
      <div
        className="flex flex-col bg-cover bg-no-repeat justify-center items-center overflow-hidden"
        style={{
        ...
        <div className="relative overflow-hidden flex flex-col justify-center gap-12 md:gap-20 items-center font-clash-display md:h-screen pb-10 bg-[#111111] !text-white">
          <div className="flex flex-col items-center justify-center md:flex-row md:justify-start md:items-start">
            <div className="flex flex-col md:flex-row md:justify-between justify-center items-center md:items-center gap-1 mt-24 md:px-12">
              ...
              <span 
                data-aos="fade-left"
                className="mt-10 text-xl !font-bricolage md:text-2xl text-[#ffffffff] md:w-1/2 px-5">
                I am a tech bro with {new Date().getFullYear() - 2019}+ years of
                experience building cool products/projects. I'm a software developer, web3
                developer, blockchain developer, DevRel, and a community
                manager. I'm a 3x Founder building products around blockchain.
                I'm the <b>Defiboy</b> :)
                <br />
                ...
                <a
                  className="underline"
                  target="_blank"
                  href="https://dativejs.js.org"
                >
                  Dativejs
                </a>
                . You like my works/projects or me 😉😉 show it on my{" "}
                <a
                  className="underline"
                  href="https://www.buymeacoffee.com/tobithealpha"
                  target="_blank"
      ...
      <div className="relative overflow-hidden flex flex-col justify-center gap-12 md:gap-20 items-center font-clash-display pt-10 pb-10 md:h-screen w-screen bg-black !text-white">
        <div className="flex flex-col items-center justify-center">
          <div className="flex flex-col gap-10">
            <h1 className="text-3xl md:text-[80px] text-center !font-bricolage uppercase font-bold">
              Brands i/i've worked for
            </h1>
            <div className="px-10 md:px-0 grid grid-cols-4 gap-4 md:grid-cols-4 place-items-center">
              ...
              <img
                src={zendmart}
                alt="zendmart"
                className="object-contain w-[200px] grayscale hover:grayscale-0 md:h-[200px]"
              />
              <img
                src={sendtokens}
                alt="sendtokens"
