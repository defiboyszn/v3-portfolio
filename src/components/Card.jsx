export const Card = ({ children,h=false }) => {
    return (
        <div className="relative group w-full">
            ...
            /> */}
            <div className={`relative flex flex-col justify-center transition-all duration-[0.2s] ease-in bg-transparent items-center group-hover:-top-1 w-full border-t border-b border-black px-10 h-[66px] md:h-[100px]`}>
                {children}
            </div>
        </div>
    )
