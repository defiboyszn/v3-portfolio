        ...
        <>
            <motion.div className="fixed z-[99999] bg-[#111]/40 w-screen grid place-self-center md:px-10 h-20 !text-[#fff]">
                <motion.div className="px-4 py-6 flex flex-row justify-between items-center">
                    <div className="flex flex-row items-center gap-1">
                        ...
                        <motion.h1 className="text-xl hidden md:block text-white font-bricolage lg:text-3xl uppercase font-bricolage">Defiboy</motion.h1>
                    </div>
                    <motion.div>
                    </motion.div>
            ...
            >
                <motion.div className="flex flex-row space-x-6">
                    ...
                    <a href="https://twitter.com/defiboyszn">
                        <svg
                    ...
                    <a href="https://instagram.com/defiboyszn">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                            data-color="#8a3ab9"
